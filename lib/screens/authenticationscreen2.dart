...
class MLAuthenticationScreen extends StatefulWidget {
  ...
  @override
  State<MLAuthenticationScreen> createState() => _MLAuthenticationScreenState();
}
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  createRichText(list: [
                    ...
                    TextSpan(text: phoneNumber!, style: boldTextStyle(color: colorDarkBlue)),
                  ]),
                  16.height,
                  otpField(),
                  24.height,
                    ...
                    children: <Widget>[
                      ...
                      AppTextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          prefixIcon: const Icon(Icons.lock_outline, size: 20, color:  white ),
