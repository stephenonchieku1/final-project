import 'package:finalproject/components/productdetail.dart';
...
class MLProductDetailScreen extends StatefulWidget {
  ...
  const MLProductDetailScreen({super.key});
              ...
              slivers: <Widget>[
                          ...
                          child: Stack(
                            ...
                            children: [
                              PageView(
                                ...
                                children: slides.map(
                                  (e) {
                                    return commonCachedNetworkImage(e.validate(), fit: BoxFit.cover);
                                  },
                                ).toList(),
                              ),
                              Row(
                ...
                SliverList(
                  delegate: SliverChildBuilderDelegate(
                    (context, index) {
                      if (index == 0) {
                        return const MLProductDetailComponent();
                      }
                      return null;
                    },
                  ),
