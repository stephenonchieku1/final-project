import 'package:finalproject/components/categorycomponent.dart';
import 'package:finalproject/components/categoryproduct.dart';
...
class MLOnlinePharmacyDetailScreenState extends State<MLOnlinePharmacyDetailScreen> {
  List<Widget> data = [const MLCategoryComponent(), const MLCategoryProductComponent()];
          ...
          children: [
            Column(
              children: [
                ...
                Row(
                  children: [
                    Text('Online Pharmacy ', style: secondaryTextStyle(size: 12, color: white.withOpacity(0.4))),
                    (widget.index == 0)
                        ? Text(
                            '> Prescription Drug',
                            style: secondaryTextStyle(size: 12, color: white.withOpacity(0.4)),
                          )
                        : Text(
                            '> Prescription Drug > Analgesic',
                            style: secondaryTextStyle(size: 12, color: white.withOpacity(0.3)),
                          ),
                  ],
                ).paddingLeft(8.0),
              ],
