...
Widget mlSelectedNavigationbarIcon(IconData iconData) {
  return Container(
    ...
    child: Icon(iconData, size: 22, color: colorDarkBlue),
  );
}
...
Widget placeHolderWidget({double? height, double? width, BoxFit? fit, AlignmentGeometry? alignment, double? radius}) {
  return Image.asset('assests/images/placeholder.jpg', height: height, width: width, fit: fit ?? BoxFit.cover, alignment: alignment ?? Alignment.center).cornerRadiusWithClipRRect(radius ?? defaultRadius);
}
