import 'package:finalproject/components/clinicvisitcomponent.dart';
import 'package:finalproject/components/confirmappointment.dart';
import 'package:finalproject/components/doctorlist.dart';
import 'package:finalproject/components/hospitallist.dart';
import 'package:finalproject/components/patient.dart';
...
import 'package:finalproject/models/notificationdata2.dart';
import 'package:finalproject/models/ordersucessdata2.dart';
import 'package:finalproject/models/servicedata2.dart';
import 'package:finalproject/models/specialistdata2.dart';
import 'package:finalproject/models/tophospitaldata2.dart';
...
import 'package:finalproject/models/paymentdata.dart';
import 'package:finalproject/models/profilecarddata.dart';
import 'package:finalproject/screens/covid19screen.dart';
import 'package:finalproject/screens/diseasescreen.dart';
import 'package:finalproject/screens/onlinepharmacyscreen.dart';
import 'package:finalproject/screens/videocounsultscreen.dart';
...
List<MLServicesData> mlServiceDataList() {
  ...
  list.add(MLServicesData(title: 'Clinic Visit', icon: Icons.home_work_outlined, image: ml_ic_dashClinicVisit, widget: const MLBookAppointmentScreen(index: 0)));
  list.add(MLServicesData(title: 'Home Visit', icon: Icons.home, image: ml_ic_dashHomeVisit, widget: const MLBookAppointmentScreen(index: 0)));
  list.add(MLServicesData(title: 'Video Consult', icon: Icons.video_call, image: ml_ic_dashVideoCons, widget: const MLVideoConsultScreen()));
  list.add(MLServicesData(title: 'Pharmacy', icon: Icons.local_hospital, image: ml_ic_dashPharmacy, widget: const MLOnlinePharmacyScreen()));
  list.add(MLServicesData(title: 'Diseases', icon: Icons.health_and_safety, image: ml_ic_dashDisease, widget: const MLDiseaseScreen()));
  list.add(MLServicesData(title: 'Covid-19', icon: Icons.supervised_user_circle_outlined, image: ml_ic_dashCovid, widget: const MLCovidScreen()));
  return list;
}
...
List<MLBookAppointmentData> mlBookAppointmentDataList() {
  ...
  list.add(MLBookAppointmentData(id: '2', title: 'Choose Hospital', widget: const MLHospitalListComponent(), progress: 0.4));
  list.add(MLBookAppointmentData(id: '3', title: 'Choose Doctor', widget: const MLDoctorListComponent(), progress: 0.6));
  list.add(MLBookAppointmentData(id: '4', title: 'Choose Patient', widget: const MLPatientComponent(), progress: 0.8));
  list.add(MLBookAppointmentData(id: '5', title: 'Confirm Appointment', widget: const MLConfirmAppointmentComponent(), progress: 1.0));
  return list;
}
