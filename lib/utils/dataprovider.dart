...
import 'package:finalproject/models/appointmentmodel.dart';
...
List<MLDiseaseData> mlDiseaseDataList() {
  ...
  list.add(MLDiseaseData(
      image: ml_ic_toothDisease, title: 'Toothache', subtitle: 'Tooth'));
  list.add(MLDiseaseData(
      image: ml_ic_ThroatPainDisease,
      title: 'Throat Pain',
      subtitle: 'Throat'));
  list.add(MLDiseaseData(
      image: ml_ic_soreThroatDisease,
      title: 'Sore Throat',
      subtitle: 'Throat'));
  list.add(MLDiseaseData(
      image: ml_ic_headacheDisease, title: 'Headache', subtitle: 'Head'));
