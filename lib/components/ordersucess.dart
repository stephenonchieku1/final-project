...
import 'package:finalproject/screens/orderdetailscreen.dart';
...
class MLOrderSuccessComponent extends StatefulWidget {
  ...
  const MLOrderSuccessComponent({super.key});
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            const MLOrderDetailScreen().launch(context);
          }),
          16.height,
          Row(
            ...
            children: data.map(
              (e) {
                return Row(
                  ...
                  children: [
                    const Icon(Icons.rounded_corner, size: 16, color: black),
                    4.width,
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
