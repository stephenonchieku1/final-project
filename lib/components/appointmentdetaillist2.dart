...
class MLAppointmentDetailList extends StatefulWidget {
  const MLAppointmentDetailList({super.key});
...
class MLAppointmentDetailListState extends State<MLAppointmentDetailList> {
  ...
  Widget mOption(var value) {
    return RichText(
      text: TextSpan(
        children: [
          WidgetSpan(child: const Icon(Icons.location_searching, size: 12).paddingRight(8)),
            ...
            Row(
              children: [
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('Doctor', style: secondaryTextStyle(color:  white  )),
                    8.height,
            ...
            Row(
              children: [
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('Patient', style: secondaryTextStyle(color:  white  )),
                    8.height,
