import 'package:finalproject/components/covidtopregion.dart';
...
class MLVaccineComponent extends StatefulWidget {
  ...
  const MLVaccineComponent({super.key});
        ...
        child: Column(
          ...
          children: [
            Row(
              ...
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                const Icon(Icons.opacity, color:  white , size: 24),
                8.width,
                Text(
            ...
            16.height,
            Text('Dashboard', style: boldTextStyle(size: 18, color:  white )),
            16.height,
            Row(
              crossAxisAlignment: CrossAxisAlignment.start,
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                ...
                Column(
                  ...
                  children: [
                    Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const Icon(Icons.brightness_1_rounded, color: Colors.green, size: 16),
                        8.width,
                        Column(
                          mainAxisAlignment: MainAxisAlignment.start,
                          crossAxisAlignment: CrossAxisAlignment.start,
                    ...
                    Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const Icon(Icons.brightness_1_rounded, color: Colors.cyanAccent, size: 16),
                        8.width,
                        Column(
                          mainAxisAlignment: MainAxisAlignment.start,
                          crossAxisAlignment: CrossAxisAlignment.start,
            ...
            32.height,
            const MLCovidTopRegionComponent(),
            16.height
          ],
        ),
      ).paddingAll(16.0),
