import 'package:finalproject/components/profilebottomcomponent.dart';
          ...
          slivers: <Widget>[
              ...
              flexibleSpace: FlexibleSpaceBar(
                background: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      CircleAvatar(radius: 40.0, backgroundColor: colorCyan, child: Image.asset(ml_ic_profile_picture)),
                      8.height,
            ...
            SliverList(
              delegate: SliverChildBuilderDelegate(
                (context, index) {
                  if (index == 0) {
                    return const MLProfileBottomComponent();
                  }
                  return null;
                },
              ),
