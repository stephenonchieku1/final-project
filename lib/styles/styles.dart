...
Color mlColorLightGrey =  Colors.black ;
Color mlColorLightGrey100 = Colors.grey.shade100;
Color mlColorGreyShade = const Color(0xfff5f5f5);
...
class Styles {
  ...
  TextStyle mediumBlack = const TextStyle(
      fontSize: 16,
...
Color colorDarkBlue = Colors.blue.shade700;
Color colorRed = Colors.red;
Color colorCyan = Colors.cyan.shade300;
Color colorLightGrey =  Colors.black ;
Color colorLightGrey100 = Colors.grey.shade100;
Color colorGreyShade = const Color(0xfff5f5f5);
